...
const required = [
  ...
  "public/skills/emailagentskill/SKILL.md",
  "public/.well-known/skills/emailagentskill/SKILL.md",
  "public/.well-known/agent-skills/emailagentskill/SKILL.md",
...
if (!markdown.includes("npx skills add emailagentskill")) throw new Error("Missing markdown install shortcut");
...
if (indexJson.skills?.[0]?.name !== "emailagentskill") throw new Error("Invalid well-known skills index");
